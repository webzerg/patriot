...
<Flex h={['100vh']} >
  <Flex w={[1,1, 0.4]} align='center' justify='center' >
    ...
    <Absolute left right bottom h={[450]} ><BackgroundGradient gradient='purpleTransparent' o={1} /></Absolute>
    <Image h={400} src={imageBanner}/>
    <Shape top bottom right h={[1]} svg={assets.svg.anglesVertical} w={[100]} z={0} />
  </Flex>
  <Flex w={[1,1, 0.6]} align='center' >
    <Container
          ...
          <Box>
            ...
            <Flex mt={[15,30]}>
              <Box w={[1,1,0.5]} >
                <SVG svg={assets.svg.bell} svgColor='blue' h={35} w={35}/>
                <Paragraph f={[1]}>
              ...
              <Box w={[1,1,0.5]} >
                <SVG svg={assets.svg.dna} svgColor='blue' h={35} w={35}/>
                <Paragraph f={[1]}>
                  Nulla blandit, urna ut suscipit rutrum, quam diam porttitor nulla, sed iaculis orci sapien nec velit. Quisque consectetur eleifend risus. 
                </Paragraph>
              </Box>
